...
20 IF (ios/=0) STOP "problem reading files"
  ...
  ALLOCATE( proj2(10,nbnd,nks) )

  proj2 = 0.d0
  DO nwfc = 1, natomwfc
     !                    orb-oder, atom-order, atom-type, orbital-type(s,p,d),
     !                    wfc, l, m
     READ(1, *, ERR=20, IOSTAT=ios) idum, idum, atyp, orbtype, wfcorder, lorder, morder
     DO n=1,nks
        DO ibnd=1,nbnd
           READ(1, '(2i8,f20.10)', ERR=20, IOSTAT=ios) idum,idum,proj(nwfc,ibnd,n)
           proj2(wfcorder,ibnd,n) = proj2(wfcorder,ibnd,n) + abs(proj(nwfc,ibnd,n)) !* proj(nwfc,ibnd,n)
           !write(60,*) wfcorder,ibnd,n, nwfc,proj2(wfcorder,ibnd,n)
        ENDDO
     ENDDO
  ENDDO
  CLOSE(1)
  ...
  write(2,*) 'k   E, porj(s, p, d)'
  DO i=1,nbnd
     DO n=1,nks
         WRITE (2,'(10f10.4)') kx(n), e(i,n), proj2(1:3,i,n)
     ENDDO
     write(2,*)
  ENDDO
